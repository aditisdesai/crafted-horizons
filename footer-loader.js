      ...
      <div class="footer-columns">
        ...
        <div class="footer-col">
          ...
          <div class="footer-social-icons" aria-label="Social links">
            <a class="social-icon" href="PASTE_INSTAGRAM_LINK" target="_blank" rel="noreferrer" aria-label="Instagram">
              <!-- Instagram -->
            ...
            <a class="social-icon" href="PASTE_TIKTOK_LINK" target="_blank" rel="noreferrer" aria-label="TikTok">
              <!-- TikTok (simple) -->
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a class="social-icon" href="PASTE_LINKEDIN_LINK" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              <!-- LinkedIn -->
              <svg viewBox="0 0 24 24" aria-hidden="true">
