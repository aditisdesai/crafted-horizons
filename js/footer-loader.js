  ...
  <div class="wrap footer-inner">
      ...
      <div class="footer-columns">
        ...
        <div class="footer-col">
          ...
          <div class="footer-social-icons" aria-label="Social links">
            <a class="social-icon" href="https://www.instagram.com/craftedhorizonsbyaditi/" target="_blank" rel="noreferrer" aria-label="Instagram">
              <!-- Instagram -->
            ...
            <a class="social-icon" href="https://www.tiktok.com/@craftedhorizonsbyaditi" target="_blank" rel="noreferrer" aria-label="TikTok">
              <!-- TikTok (simple) -->
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a class="social-icon" href="https://www.facebook.com/craftedhorizonsbyaditi/" target="_blank" rel="noreferrer" aria-label="Facebook">
              <!-- Facebook -->
              <svg viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a class="social-icon" href="https://www.linkedin.com/in/aditi-desai-a4473b5/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              <!-- LinkedIn -->
              <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div class="footer-bottom">
      ...
      <p class="footer-small">
        Content and images may not be reproduced without permission.
      </p>
      <p class="footer-small">
